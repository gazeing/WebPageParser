...
public class DisqusWebviewChromeClient extends WebChromeClient {
...
//    private View loadingText;
    ...
    public DisqusWebviewChromeClient(/*CordovaWebView webView,ViewGroup toolb,View load,*/ ViewGroup container,Context context) {
        super();
...
//		Log.i(LOG_TAG, "onProgressChanged: "+ newProgress); 
		super.onProgressChanged(view, newProgress);
//		
//		if ((newProgress>88)&&(newProgress-preProgress>0)) {
//			if (GlobalData.m_loadingFinishListener!=null)
//				GlobalData.m_loadingFinishListener.onTaskComplete(new TaskComplete(TaskComplete.MAINPAGE_LOADING_FINISH));
//		}
